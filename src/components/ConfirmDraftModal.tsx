    ...
    <div className="fixed inset-0 z-20 flex items-end justify-center bg-black/40 sm:items-center">
      <div className="w-full max-w-lg rounded-t-2xl bg-white p-5 shadow-xl sm:rounded-2xl">
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-ink">Confirm expenses</h2>
        ...
        {draft.transcript && (
          <p className="mb-3 rounded-lg bg-paper px-3 py-2 text-sm text-muted">
        ...
        <div className="mt-4 flex items-center justify-between border-t border-black/10 pt-3">
          <span className="text-sm text-muted">
            Total: <span className="font-medium text-ink">₹{total.toLocaleString("en-IN")}</span>
          </span>
